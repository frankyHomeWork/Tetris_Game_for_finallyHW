...
} GamePrinter = {initGameSurface, showGameSurface, check_can_add_block,
                 check_is_GameOver, set_tetris_block,
                 set_tetris_blockToFixSurface, getFixGameSurface_PointNode,
                 check_is_need_stop, check_is_LinkLine, deleteSurfaceLine,
                 shiftDownSurfaceLine,

                 showGameScore, showNextBlock, clearNextBlock,
